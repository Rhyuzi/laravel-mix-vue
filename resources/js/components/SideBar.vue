            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section active">
                ...
                <ul class="nav side-menu" style="">
                  ...
                  <li @click="dropdownDash" class="active"><a><i class="fa fa-table"></i> Dashboard Pelanggan <span :class="{'fa fa-chevron-up': ddDash, 'fa fa-chevron-down': !ddDash}"></span></a>
                  ...
                  <li class="active"><a><i class="fa fa-table"></i> System <span :class="{'fa fa-chevron-up': ddDash, 'fa fa-chevron-down': !ddDash}"></span></a>
